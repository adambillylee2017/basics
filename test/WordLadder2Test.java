...
public class WordLadder2Test {
    WordLadder2.Solution sol = new WordLadder2.Solution();
    ...
    public void findLadders1() throws Exception {
        ...
        String endWord = "cog";
        List<List<String>> rst = sol.findLadders(beginWord, endWord, wordList);
    ...
    @Test
    public void findLadders3() throws Exception {
    ...
    @Test
    public void findLadders4() throws Exception {
        String words[] = {"a", "b", "c"};
        List<String> wordList = Arrays.stream(words).collect(Collectors.toList());
